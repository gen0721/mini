    ...
    <div style={{ maxWidth:680, margin:'0 auto', padding:'32px 20px' }}>
      ...
      <div style={{ background:'var(--bg2)', border:'1px solid var(--border)', borderRadius:20, padding:28 }}>
        ...
        <Field label="ОПИСАНИЕ *">
          <textarea className="inp" rows={5} placeholder="Подробно опишите товар: характеристики, что входит, особенности..." value={form.description} onChange={e=>upd('description',e.target.value)} maxLength={3000} style={{ resize:'vertical' }}/>
        ...
        <Field label="ДАННЫЕ ТОВАРА (скрыты до сделки)">
          <textarea className="inp" rows={3} placeholder="Логин: example&#10;Пароль: password123&#10;Ключ: XXXXX-XXXXX" value={form.deliveryData} onChange={e=>upd('deliveryData',e.target.value)} style={{ resize:'vertical' }}/>
