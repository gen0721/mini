  ...
  return (
    <div style={{ maxWidth:1200, margin:'0 auto', padding:'32px 20px' }}>
      ...
      <div style={{ display:'flex', gap:10, marginBottom:24 }}>
        <input className="inp" placeholder="🔍 Поиск товаров..." value={searchInput} onChange={e=>setSearchInput(e.target.value)} onKeyDown={e=>e.key==='Enter'&&applySearch()} style={{ flex:1 }}/>
      ...
      {loading && page===1 ? (
        ...
        <>
          <div className="grid-4">
            {products.map((p,i)=><ProductCard key={p._id} product={p} style={{animationDelay:`${i*30}ms`}}/>)}
          </div>
