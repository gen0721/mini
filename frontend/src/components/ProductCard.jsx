...
export default function ProductCard({ product, style={} }) {
  ...
  return (
    <Link to={`/product/${product._id}`} style={{ textDecoration:'none', display:'block', ...style }}>
      <div className="card" style={{ cursor:'pointer' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            background:'linear-gradient(transparent, rgba(13,13,20,0.9))'
          }}/>
        ...
        <div style={{ padding:'14px 16px' }}>
          <div style={{ fontFamily:'var(--font-h)', fontWeight:700, fontSize:15, marginBottom:6, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap', color:'var(--t1)' }}>
            {product.title}
          </div>
